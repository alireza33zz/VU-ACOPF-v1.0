...
printstyled("\nTotal Load Phase a: ", round(phase_loads["a"], digits=3), " kW", round(phase_loads["a"]/total_pl, digits=3), "\n", color=:blue)
printstyled("Total Load Phase b: ", round(phase_loads["b"], digits=3), " kW", round(phase_loads["b"]/total_pl, digits=3), "\n", color=:yellow)
printstyled("Total Load Phase c: ", round(phase_loads["c"], digits=3), " kW", round(phase_loads["c"]/total_pl, digits=3), "\n", color=:red)
